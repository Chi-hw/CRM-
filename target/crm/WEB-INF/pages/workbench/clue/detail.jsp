			...
			$.ajax({
				...
				success:function (data) {
					if (data.code=="0"){
						...
						htmlStr+="<font color=\"gray\">线索活动</font> <font color=\"gray\">-</font> <b>${clue.fullName}</b> <small style=\"color: gray;\"> "+data.retData.createTime+" 由${sessionScope.sessionUser.name}创建</small>";
	...
	<c:forEach items="${remarkList}" var="remark">
		<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				...
				<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullName}</b> <small style="color: gray;"> ${remark.editFlag==0?remark.createTime:remark.editTime}
				...
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" name="deleteA" remarlId="${remark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
				</div>
			</div>
		</div>
	</c:forEach>
