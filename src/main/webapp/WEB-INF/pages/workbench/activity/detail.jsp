...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#saveCreateRemarkBtn").click(function () {
            ...
            var activityId='${activity.id}';  //当本行js代码在浏览器执行时，${activity.id}已经变成32位字符
            //表单验证
            if(noteContent==""){
                alert("请输入备注内容");
                return ;
        ...
        $("#remarkDivList").on("click","a[name='deleteA']",function () {//采用自定义属性定位元素
            var id=$(this).attr("remarkId");//收集参数
            //发送请求
            $.ajax({
            ...
            <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
                ...
                <div style="position: relative; top: -40px; left: 40px;" >
                    ...
                    由${remark.editFlag==0?remark.createBy:remark.editBy}
                        ${remark.editFlag==0?'创建':'修改'}
                </small>
                    <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                        <a class="myHref" href="javascript:void(0);" name="editA" remarkId="${remark.id}">
                        ...
                        <a class="myHref" name="deleteA" remarkId="${remark.id}" href="javascript:void(0);">
                            <span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;">
                            </span></a>
                    </div>
                </div>
            </div>
